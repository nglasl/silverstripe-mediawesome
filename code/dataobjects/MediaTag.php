...
class MediaTag extends DataObject {
	...
	public function validate() {
		...
		!$this->Title ? $result->error('Title required!') : (MediaTag::get_one('MediaTag', "ID != " . intval($this->ID) . " AND Title = '" . Convert::raw2sql($this->Title) . "'") ? $result->error('Tag already exists!') : $result->valid());
